<header class="header sticky-scroll-menu w-btn-hide">
  <!-- header profile -->
  <div class="profile">
    <div class="title">EliteDev Emon</div>
  ...
  <div class="top-menu top-menu-onepage menu-minimal">
    <div class="menu-main-menu-container">
      <ul class="menu" id="menu-main-menu">
        <li
          class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-40 current_page_item"
          data-id="menu-item-2149">
          <a class="one-page-menu-item" href="#home"><span class="icon fas fa-user-edit"></span><span
              class="name">About</span></a>
        </li>
        <li class="menu-item menu-item-type-post_type menu-item-object-page" data-id="menu-item-2158"><a
            class="one-page-menu-item" href="#skills"><span class="icon fas fa-dumbbell"></span><span
              class="name">Skills</span></a></li>
